...
import { StyledCardLink, StyledContentWrapper, StyledDescription, StyledFootnote, StyledImage, StyledOurRealizationsCards, StyledTitle, StyledWrapper } from './ourRealizationsCards.styles';
...
const OurRealizationsCards = () => {
    ...
    const { allDatoCmsRealization: { edges } } = useStaticQuery(graphql`
    ...
    return (
        <StyledOurRealizationsCards>
            <StyledSecondTitle>
                {ourRealizationsLabels.title}
            </StyledSecondTitle>
            <StyledWrapper>
                {edges.map(({ node: { thumbnail, thumbnailDescription, title, cattering, numberOfPersons, id, slug } }) => (
                        ...
                        <StyledContentWrapper>
                            ...
                            <StyledFootnote>
                                <p>
                                    ...
                                    <span style={{ color: 'var(--green)', marginLeft: '7px' }}>
                                        {cattering
